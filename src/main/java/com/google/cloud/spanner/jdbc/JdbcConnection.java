...
class JdbcConnection extends AbstractJdbcConnection {
  ...
  public JdbcPreparedStatement prepareStatement(String sql) throws SQLException {
    return internalPrepareStatement(sql, null);
  }

  private JdbcPreparedStatement internalPrepareStatement(
      String sql, @Nullable ImmutableList<String> generatedKeyColumns) throws SQLException {
    checkClosed();
  ...
  public PreparedStatement prepareStatement(String sql, int autoGeneratedKeys) throws SQLException {
    return internalPrepareStatement(
        sql, autoGeneratedKeys == Statement.RETURN_GENERATED_KEYS ? ALL_COLUMNS : null);
  }
